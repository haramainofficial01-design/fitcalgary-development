...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  static const pages = [
    ...
    (
      ...
      title: 'Know what\nyou pay.',
      body: 'Compare advertised rates with the normalized all-in monthly cost across the city.',
                  ...
                  AnimatedSwitcher(
                    ...
                    child: last
                        ? Column(
                            ...
                            children: [
                              FilledButton(
                                onPressed: finishing ? null : widget.onAccount,
                                child: const Text(
                              ...
                              OutlinedButton(
                                ...
                                child: Text(
                                  finishing ? 'OPENING…' : 'EXPLORE FITCALGARY',
                                ),
                              ),
                            ],
                          )
